...
from ...models.models_model_upsert_request import ModelsModelUpsertRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ModelsModelListItem | str | None:
    if response.status_code == 201:
        response_201 = ModelsModelListItem.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """ Create model
     ...
     Create a user-owned model configuration row.
