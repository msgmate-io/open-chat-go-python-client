...
from ...models.get_random_number_seeded_call import GetRandomNumberSeededCall
...
def _get_kwargs(
    *,
    body: GetRandomNumberSeededCall,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/tools/typing/get_random_number_seeded/call/validate",
    }
...
def sync_detailed(
    *,
    ...
    """ Validate get_random_number_seeded call payload

     Validate payload for tool `get_random_number_seeded` call arguments.

    Args:
        body (GetRandomNumberSeededCall): The parameters for the tool
