...
from ...models.post_api_v1_tools_typing_tool_name_init_validate_body import PostApiV1ToolsTypingToolNameInitValidateBody
...
def _get_kwargs(
    tool_name: str,
    *,
    body: PostApiV1ToolsTypingToolNameInitValidateBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/tools/typing/{tool_name}/init/validate".format(tool_name=quote(str(tool_name), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Validate tool init payload

     Validate a JSON object payload for a tool init config by tool name.
