...
from ...models.get_random_number_seeded_init import GetRandomNumberSeededInit
...
def _get_kwargs(
    *,
    body: GetRandomNumberSeededInit,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/tools/typing/get_random_number_seeded/init/validate",
    }
...
def sync_detailed(
    *,
    ...
    """ Validate get_random_number_seeded init payload

     Validate payload for tool `get_random_number_seeded` init configuration.
