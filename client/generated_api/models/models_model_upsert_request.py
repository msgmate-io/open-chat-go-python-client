...
T = TypeVar("T", bound="ModelsModelUpsertRequest")



@_attrs_define
class ModelsModelUpsertRequest:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        models_model_upsert_request = cls(
        ...
        models_model_upsert_request.additional_properties = d
        return models_model_upsert_request
